...
| Provider Selection Waist | `.context/architecture/provider-selection-waist.md`       | Where Sunrise decides which LLM vendor sees a request; why the coverage table is not a boundary and a call-time gate is                  |
