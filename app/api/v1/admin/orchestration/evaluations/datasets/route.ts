...
export const GET = withAdminAuth(
  ...
  },
  {
    ownership: {
      decidedBy: 'self',
      because:
        'Lists datasets under the visible clause for this caller — rows they own, plus rows nobody owns where canRead permits an unattributed read — and counts with the same clause. Never a row belonging to another subject.',
    },
  }
);
...
export const POST = withAdminAuth(
  ...
  },
  {
    ownership: {
      decidedBy: 'self',
      because:
        'Creates a dataset stamped with the userId of the caller. Reads no rows belonging to another subject.',
    },
  }
);
