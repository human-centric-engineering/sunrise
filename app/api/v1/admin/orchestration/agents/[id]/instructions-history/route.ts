 ...
 *   `systemInstructionsHistory` array (newest first). The history
 *   column is parsed via `systemInstructionsHistorySchema` with
 *   warn-and-skip on malformed rows — same pattern used by the
