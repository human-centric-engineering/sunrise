...
## app/api/v1/admin/orchestration (unit)

All tbt hits are structural boolean assertions (body.success API envelope, boolean response fields). All nac hits are zero-arg side-effect triggers (createRateLimitResponse, clearMcpXxxCache, broadcastMcpXxxChanged). All ctn are in beforeEach. No real quality issues — raw grades reflect regex density before annotation.

| test_file | type | grade | sig_hits | block_patterns | test_count | last_head | last_scanned | notes |
|------|------|-------|----------|----------------|------------|-----------|--------------|-------|
| tests/unit/app/api/v1/admin/orchestration/agents/[id]/versions/[versionId]/restore/route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 15 | 03c1a5e512a9cea6a601c20cd3d779119c1a13eb | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/agents/agent-system-protection.route.test.ts | unit | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 10 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/unit/app/api/v1/admin/orchestration/agents/capabilities-usage.route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/agents/embed-tokens/[tokenId]/route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 11 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/agents/embed-tokens/route.test.ts | unit | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 11 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/unit/app/api/v1/admin/orchestration/agents/invite-tokens/invite-tokens.route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 15 | N/A | 2026-04-26T17:12:03Z | nac=1 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/agents/versions/route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 8 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/analytics/analytics.route.test.ts | unit | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 24 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/unit/app/api/v1/admin/orchestration/audit-log/route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 20 | 7adb72cd7a54c42ca35b1123fe07810e62574947 | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/capabilities/capability-system-protection.route.test.ts | unit | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 4 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/unit/app/api/v1/admin/orchestration/conversations/export/route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 17 | b5bfb23c14d919c828010bc43c2c51cd0a3eff9e | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/conversations/search/route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 15 | 296386ad323080a7865d205045be6fa133101855 | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/costs/alerts/route.test.ts | unit | Bad | 1 | hpo=0,mp=0,me=0,tcm=0 | 5 | d47f378eb16e60d96bad37d57f192854c46fa082 | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/costs/route.test.ts | unit | Bad | 1 | hpo=0,mp=0,me=0,tcm=0 | 6 | 677788f8ce59cc2e49eaf2e77069afda8dcde4e7 | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/costs/summary/route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 9 | 6f0a3b18da0dc2fc125072c79f37dabf8cac214e | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/hooks/[id]/deliveries/route.test.ts | unit | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 8 | bcbeea8b01001c44296cdcdaf7077dd8e084a5b7 | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/unit/app/api/v1/admin/orchestration/hooks/[id]/rotate-secret/route.test.ts | unit | Minor | 2 | hpo=0,mp=0,me=0,tcm=0 | 18 | 25fdbf38a31be6e2b5da9682af50ea6c286b0b6c | 2026-04-26T17:12:03Z | tbt=2 FP (body.success/boolean). ctn=2 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/hooks/deliveries/[id]/retry/route.test.ts | unit | Bad | 1 | hpo=0,mp=0,me=0,tcm=0 | 6 | bcbeea8b01001c44296cdcdaf7077dd8e084a5b7 | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/hooks/route.test.ts | unit | Minor | 2 | hpo=0,mp=0,me=0,tcm=0 | 33 | 553b546dca469dcd3fdb3bbe14deb9eaf6f1d322 | 2026-04-26T17:12:03Z | tbt=2 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/knowledge/documents/[id]/chunks/route.test.ts | unit | Bad | 1 | hpo=0,mp=0,me=0,tcm=0 | 6 | ed23a1d1c982f8f214ac7044ab7cf9ab51474bee | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/knowledge/documents/[id]/confirm/route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 12 | 2c3a904dc9d6f92308efe66b4c2a01c42dcc4908 | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/knowledge/documents/route.test.ts | unit | Clean | 1 | hpo=0,mp=0,me=0,tcm=0 | 21 | 5c6b4690a15599f2e02f2be71d803954005dc078 | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/knowledge/graph/route.test.ts | unit | Minor | 2 | hpo=0,mp=0,me=0,tcm=0 | 27 | 48c4c579be945960c588b529c40571bfe8b25d37 | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). nac=1 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/maintenance/tick/route.test.ts | unit | Bad | 3 | hpo=0,mp=0,me=0,tcm=0 | 18 | bcbeea8b01001c44296cdcdaf7077dd8e084a5b7 | 2026-04-26T17:12:03Z | tbt=3 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/mcp/audit/route.test.ts | unit | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 13 | 4206d846e4c801c318a8e9883573a2ce8f8e4cbe | 2026-04-26T17:12:03Z | nac=2 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/mcp/keys/[id]/rotate/route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 11 | fe55dbe4355cfc771936d7ca6cae4c1bf986d230 | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/mcp/keys/[id]/route.test.ts | unit | Bad | 3 | hpo=0,mp=0,me=0,tcm=0 | 15 | fe55dbe4355cfc771936d7ca6cae4c1bf986d230 | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). nac=2 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/mcp/keys/route.test.ts | unit | Minor | 2 | hpo=0,mp=0,me=0,tcm=0 | 16 | fe55dbe4355cfc771936d7ca6cae4c1bf986d230 | 2026-04-26T17:12:03Z | nac=2 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/mcp/resources/[id]/route.test.ts | unit | Rotten | 7 | hpo=0,mp=0,me=0,tcm=0 | 16 | 7e860aca3223e38840c732e221f760169f39669b | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). nac=6 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/mcp/resources/route.test.ts | unit | Bad | 4 | hpo=0,mp=0,me=0,tcm=0 | 14 | 7e860aca3223e38840c732e221f760169f39669b | 2026-04-26T17:12:03Z | nac=4 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/mcp/sessions/[id]/route.test.ts | unit | Rotten | 2 | hpo=0,mp=0,me=0,tcm=0 | 5 | 7e860aca3223e38840c732e221f760169f39669b | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). nac=1 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/mcp/sessions/route.test.ts | unit | Rotten | 2 | hpo=0,mp=0,me=0,tcm=0 | 6 | 7e860aca3223e38840c732e221f760169f39669b | 2026-04-26T17:12:03Z | nac=2 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/mcp/settings/route.test.ts | unit | Rotten | 5 | hpo=0,mp=0,me=0,tcm=0 | 16 | 7e860aca3223e38840c732e221f760169f39669b | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). nac=4 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/mcp/tools/[id]/route.test.ts | unit | Rotten | 7 | hpo=0,mp=0,me=0,tcm=0 | 17 | 7e860aca3223e38840c732e221f760169f39669b | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). nac=6 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/mcp/tools/route.test.ts | unit | Bad | 4 | hpo=0,mp=0,me=0,tcm=0 | 16 | 7e860aca3223e38840c732e221f760169f39669b | 2026-04-26T17:12:03Z | nac=4 FP (zero-arg side-effects). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/providers/test-model.route.test.ts | unit | Bad | 3 | hpo=0,mp=0,me=0,tcm=0 | 13 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/quiz-scores/route.test.ts | unit | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 8 | 6f0a3b18da0dc2fc125072c79f37dabf8cac214e | 2026-04-26T17:12:03Z | tbt=2 FP (body.success/boolean). ctn=2 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/schedules/schedules.route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 17 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/webhooks/deliveries/retry/route.test.ts | unit | Bad | 1 | hpo=0,mp=0,me=0,tcm=0 | 5 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/webhooks/deliveries/route.test.ts | unit | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/unit/app/api/v1/admin/orchestration/webhooks/route.test.ts | unit | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 16 | 73332024ae18ab0c7ede1486c545dc4a08a3ad18 | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/unit/app/api/v1/admin/orchestration/webhooks/test/route.test.ts | unit | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (body.success/boolean). ctn=1 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/workflows/[id]/schedules/[scheduleId]/route.test.ts | unit | Bad | 5 | hpo=0,mp=0,me=0,tcm=0 | 22 | 2c3a904dc9d6f92308efe66b4c2a01c42dcc4908 | 2026-04-26T17:12:03Z | tbt=4 FP (body.success/boolean). nac=1 FP (zero-arg side-effects). ctn=3 (beforeEach). |
| tests/unit/app/api/v1/admin/orchestration/workflows/execute-stream/route.test.ts | unit | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 12 | N/A | 2026-04-26T17:12:03Z | ctn=2 FP (beforeEach).|
| tests/unit/app/api/v1/admin/orchestration/workflows/templates/route.test.ts | unit | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 8 | 79649d544ec39a5f1694ad78737281212314682c | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|

## app/api/v1/admin/orchestration (integration)

All tbt hits are structural boolean assertions (data.success API envelope, Array.isArray, boolean response fields like .schemaCompatible/.hasFreeTier/.refreshed/.skipped). All ctn are in beforeEach. nac=1 is a bare createMany check. No real quality issues — raw grades reflect regex density before annotation.

| test_file | type | grade | sig_hits | block_patterns | test_count | last_head | last_scanned | notes |
|------|------|-------|----------|----------------|------------|-----------|--------------|-------|
| tests/integration/api/v1/admin/orchestration/agent-version-restore.test.ts | integration | Bad | 1 | hpo=0,mp=0,me=0,tcm=0 | 4 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.bulk.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.compare.test.ts | integration | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/integration/api/v1/admin/orchestration/agents.export-import-roundtrip.test.ts | integration | Rotten | 4 | hpo=0,mp=0,me=0,tcm=0 | 1 | N/A | 2026-04-26T17:12:03Z | tbt=4 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.export.test.ts | integration | Bad | 3 | hpo=0,mp=0,me=0,tcm=0 | 16 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.id.budget.test.ts | integration | Rotten | 4 | hpo=0,mp=0,me=0,tcm=0 | 7 | N/A | 2026-04-26T17:12:03Z | tbt=4 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.id.capabilities.test.ts | integration | Bad | 6 | hpo=0,mp=0,me=0,tcm=0 | 28 | N/A | 2026-04-26T17:12:03Z | tbt=6 FP (data.success/boolean). ctn=4 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.id.capabilities.usage.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 8 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.id.clone.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 12 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.id.instructions-history.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 8 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.id.instructions-revert.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 12 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.id.test.ts | integration | Minor | 3 | hpo=0,mp=0,me=0,tcm=0 | 26 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (data.success/boolean). ctn=3 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.import.test.ts | integration | Minor | 2 | hpo=0,mp=0,me=0,tcm=0 | 17 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). nac=1 FP. ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.invite-tokens.test.ts | integration | Minor | 6 | hpo=0,mp=0,me=0,tcm=0 | 46 | N/A | 2026-04-26T17:12:03Z | tbt=6 FP (data.success/boolean). ctn=4 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/agents.test.ts | integration | Bad | 3 | hpo=0,mp=0,me=0,tcm=0 | 16 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (data.success/boolean). ctn=2 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/backup/export.test.ts | integration | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 8 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/integration/api/v1/admin/orchestration/backup/import.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 8 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/capabilities.id.agents.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 10 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/capabilities.stats.test.ts | integration | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/integration/api/v1/admin/orchestration/capabilities.test.ts | integration | Minor | 4 | hpo=0,mp=0,me=0,tcm=0 | 35 | N/A | 2026-04-26T17:12:03Z | tbt=4 FP (data.success/boolean). ctn=5 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/chat.stream.test.ts | integration | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 13 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/integration/api/v1/admin/orchestration/conversations.clear.test.ts | integration | Minor | 2 | hpo=0,mp=0,me=0,tcm=0 | 16 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/conversations.id.get.test.ts | integration | Bad | 1 | hpo=0,mp=0,me=0,tcm=0 | 6 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/conversations.id.messages.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 7 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/conversations.id.patch.test.ts | integration | Bad | 1 | hpo=0,mp=0,me=0,tcm=0 | 5 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/conversations.id.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 8 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/conversations.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 15 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/costs.alerts.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 7 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/costs.summary.test.ts | integration | Rotten | 4 | hpo=0,mp=0,me=0,tcm=0 | 4 | N/A | 2026-04-26T17:12:03Z | tbt=4 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/costs.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 13 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/embedding-models.test.ts | integration | Rotten | 18 | hpo=0,mp=0,me=0,tcm=0 | 26 | N/A | 2026-04-26T17:12:03Z | tbt=18 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/evaluations.id.complete.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 11 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/evaluations.id.logs.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 10 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/evaluations.id.test.ts | integration | Minor | 2 | hpo=0,mp=0,me=0,tcm=0 | 14 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=2 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/evaluations.test.ts | integration | Minor | 2 | hpo=0,mp=0,me=0,tcm=0 | 15 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=2 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/executions.id.approve.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 10 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/executions.id.cancel.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 12 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/executions.id.retry-step.test.ts | integration | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 10 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/integration/api/v1/admin/orchestration/executions.id.test.ts | integration | Bad | 1 | hpo=0,mp=0,me=0,tcm=0 | 6 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/executions.list.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 11 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/experiments.id.run.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 13 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/experiments.id.test.ts | integration | Bad | 5 | hpo=0,mp=0,me=0,tcm=0 | 22 | N/A | 2026-04-26T17:12:03Z | tbt=5 FP (data.success/boolean). ctn=3 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/experiments.test.ts | integration | Minor | 2 | hpo=0,mp=0,me=0,tcm=0 | 16 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=2 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.documents.bulk.test.ts | integration | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 18 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/integration/api/v1/admin/orchestration/knowledge.documents.fetch-url.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 14 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.documents.id.rechunk.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.documents.id.retry.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 12 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.documents.id.test.ts | integration | Bad | 3 | hpo=0,mp=0,me=0,tcm=0 | 12 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (data.success/boolean). ctn=2 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.documents.test.ts | integration | Minor | 2 | hpo=0,mp=0,me=0,tcm=0 | 17 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=2 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.embed.test.ts | integration | Bad | 1 | hpo=0,mp=0,me=0,tcm=0 | 4 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.embedding-status.test.ts | integration | Rotten | 3 | hpo=0,mp=0,me=0,tcm=0 | 6 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.graph.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 16 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.meta-tags.test.ts | integration | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 5 | N/A | 2026-04-26T17:12:03Z | Zero-hit file.|
| tests/integration/api/v1/admin/orchestration/knowledge.patterns.number.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.patterns.test.ts | integration | Rotten | 2 | hpo=0,mp=0,me=0,tcm=0 | 4 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.search.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/knowledge.seed.test.ts | integration | Rotten | 2 | hpo=0,mp=0,me=0,tcm=0 | 6 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/maintenance.tick.test.ts | integration | Rotten | 4 | hpo=0,mp=0,me=0,tcm=0 | 5 | N/A | 2026-04-26T17:12:03Z | tbt=4 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/models.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/observability.dashboard-stats.test.ts | integration | Rotten | 3 | hpo=0,mp=0,me=0,tcm=0 | 8 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/provider-models.id.test.ts | integration | Minor | 3 | hpo=0,mp=0,me=0,tcm=0 | 27 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (data.success/boolean). ctn=3 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/provider-models.recommend.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 8 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/provider-models.test.ts | integration | Rotten | 4 | hpo=0,mp=0,me=0,tcm=0 | 13 | N/A | 2026-04-26T17:12:03Z | tbt=4 FP (data.success/boolean). ctn=2 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/providers.id.health.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=2 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/providers.id.models.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 9 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/providers.id.test-connection.test.ts | integration | Rotten | 4 | hpo=0,mp=0,me=0,tcm=0 | 8 | N/A | 2026-04-26T17:12:03Z | tbt=4 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/providers.id.test-model.test.ts | integration | Rotten | 3 | hpo=0,mp=0,me=0,tcm=0 | 10 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/providers.id.test.ts | integration | Minor | 3 | hpo=0,mp=0,me=0,tcm=0 | 23 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (data.success/boolean). ctn=3 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/providers.test.ts | integration | Bad | 4 | hpo=0,mp=0,me=0,tcm=0 | 18 | N/A | 2026-04-26T17:12:03Z | tbt=4 FP (data.success/boolean). ctn=2 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/quiz-scores.test.ts | integration | Bad | 3 | hpo=0,mp=0,me=0,tcm=0 | 18 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (data.success/boolean). ctn=2 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/settings.test.ts | integration | Clean | 1 | hpo=0,mp=0,me=0,tcm=0 | 34 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/webhooks.id.test.ts | integration | Bad | 4 | hpo=0,mp=0,me=0,tcm=0 | 23 | N/A | 2026-04-26T17:12:03Z | tbt=4 FP (data.success/boolean). ctn=3 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/webhooks.test.ts | integration | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 10 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/integration/api/v1/admin/orchestration/workflows.id.definition-history.test.ts | integration | Bad | 2 | hpo=0,mp=0,me=0,tcm=0 | 8 | N/A | 2026-04-26T17:12:03Z | tbt=2 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/workflows.id.definition-revert.test.ts | integration | Minor | 1 | hpo=0,mp=0,me=0,tcm=0 | 12 | N/A | 2026-04-26T17:12:03Z | tbt=1 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/workflows.id.dry-run.test.ts | integration | Rotten | 6 | hpo=0,mp=0,me=0,tcm=0 | 12 | N/A | 2026-04-26T17:12:03Z | tbt=6 FP (data.success/boolean). ctn=1 (beforeEach). |
| tests/integration/api/v1/admin/orchestration/workflows.id.execute.test.ts | integration | Clean | 0 | hpo=0,mp=0,me=0,tcm=0 | 12 | N/A | 2026-04-26T17:12:03Z | ctn=1 FP (beforeEach).|
| tests/integration/api/v1/admin/orchestration/workflows.id.test.ts | integration | Minor | 3 | hpo=0,mp=0,me=0,tcm=0 | 22 | N/A | 2026-04-26T17:12:03Z | tbt=3 FP (data.success/boolean). ctn=3 (beforeEach). |
