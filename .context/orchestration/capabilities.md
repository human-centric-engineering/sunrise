...
| ------------------------------------------------------ | ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `knowledge/embedder.ts` via ingestion/seeding/chunking | the per-document embedding batch    | those callers pass no attribution at all — no agent, conversation or user behind an upload. Tagged `metadata.kind` + `documentId` instead |
